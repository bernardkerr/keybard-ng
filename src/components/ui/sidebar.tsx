    ...
    return (
        ...
        >
            ...
            <div
                ...
                data-state={state}
                className={cn(
                    "fixed inset-y-0 flex h-svh w-(--sidebar-width) transition-[left,right,width] duration-300 ease-in-out",
